...
st.set_page_config(layout="wide", page_title="Rank areas of interest", page_icon=":nuage:")
st.title("Rank areas of interest")
...
while True:
    ...
    geomap = folium.Map([df.latitude.mean(), df.longitude.mean()], zoom_start=6, tiles="cartodbpositron")
